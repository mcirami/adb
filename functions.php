...
function boiler_scripts_styles() {
   ...
   /* wp_enqueue_style( 'bootstrap_css', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css' );*/
    wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri() . '/css/bootstrap/bootstrap.min.css', array(), 20141119 );
    ...
    wp_enqueue_script( 'swiper_js', get_template_directory_uri() . '/js/vendor/swiper/swiper.min.js', array('jquery'), '', true );
    wp_enqueue_script( 'boiler-concat', get_template_directory_uri() . '/js/built.min.js', array(), '', true );
    wp_enqueue_script( 'index-js', get_template_directory_uri() . '/js/vendor/index.js', array(), '', true );
}
...
if ( function_exists( 'add_image_size' ) ) {
    add_image_size( 'post-feature-img', 400, 400, true ); //(cropped)
    //add_image_size( 'member-img', 330, 455, false ); //(scaled)
}